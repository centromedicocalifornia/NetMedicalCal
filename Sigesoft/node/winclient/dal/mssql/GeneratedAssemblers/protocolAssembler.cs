...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public static partial class protocolAssembler
    {
        ...
        public static protocol ToEntity(this protocolDto dto)
        {
            ...
            entity.d_PrecioConsulta = dto.d_PrecioConsulta;
            entity.d_DescuentoLaboratorio = dto.d_DescuentoLaboratorio;
            entity.d_DescuentoRayosX = dto.d_DescuentoRayosX;
            entity.d_DescuentoEcografias = dto.d_DescuentoEcografias;
            entity.d_DescuentoFarmacia = dto.d_DescuentoFarmacia;
            entity.d_DescuentoOdontologia = dto.d_DescuentoOdontologia;
            entity.d_CamaHosp = dto.d_CamaHosp;
            entity.d_SalaOperaciones = dto.d_SalaOperaciones;
            entity.d_PrecioAmbulancia = dto.d_PrecioAmbulancia;
            entity.i_mktWork = dto.i_mktWork;
            entity.i_DateVald = dto.i_DateVald;
            entity.v_DateVAR = dto.v_DateVAR;
            entity.i_TipoConvenio = dto.i_TipoConvenio;
            entity.r_PrecioConvenio = dto.r_PrecioConvenio;
            entity.v_NombreConvenio = dto.v_NombreConvenio;
            entity.r_PrecioConsultaFijo = dto.r_PrecioConsultaFijo;
            entity.r_PrecioConsultaEspecialidad1 = dto.r_PrecioConsultaEspecialidad1;
            entity.r_PrecioConsultaEspecialidad2 = dto.r_PrecioConsultaEspecialidad2;
            entity.r_PrecioConsultaEspecialidad3 = dto.r_PrecioConsultaEspecialidad3;
        ...
        public static protocolDto ToDTO(this protocol entity)
        {
            ...
            dto.d_PrecioConsulta = entity.d_PrecioConsulta;
            dto.d_DescuentoLaboratorio = entity.d_DescuentoLaboratorio;
            dto.d_DescuentoRayosX = entity.d_DescuentoRayosX;
            dto.d_DescuentoEcografias = entity.d_DescuentoEcografias;
            dto.d_DescuentoFarmacia = entity.d_DescuentoFarmacia;
            dto.d_DescuentoOdontologia = entity.d_DescuentoOdontologia;
            dto.d_CamaHosp = entity.d_CamaHosp;
            dto.d_SalaOperaciones = entity.d_SalaOperaciones;
            dto.d_PrecioAmbulancia = entity.d_PrecioAmbulancia;
            dto.i_mktWork = entity.i_mktWork;
            dto.i_DateVald = entity.i_DateVald;
            dto.v_DateVAR = entity.v_DateVAR;
            dto.i_TipoConvenio = entity.i_TipoConvenio;
            dto.r_PrecioConvenio = entity.r_PrecioConvenio;
            dto.v_NombreConvenio = entity.v_NombreConvenio;
            dto.r_PrecioConsultaFijo = entity.r_PrecioConsultaFijo;
            dto.r_PrecioConsultaEspecialidad1 = entity.r_PrecioConsultaEspecialidad1;
            dto.r_PrecioConsultaEspecialidad2 = entity.r_PrecioConsultaEspecialidad2;
            dto.r_PrecioConsultaEspecialidad3 = entity.r_PrecioConsultaEspecialidad3;
