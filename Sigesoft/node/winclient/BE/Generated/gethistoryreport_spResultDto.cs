...
{
    [DataContract()]
    public partial class gethistoryreport_spResultDto
    {
        [DataMember()]
        ...
        public gethistoryreport_spResultDto()
        {
        }

        public gethistoryreport_spResultDto(String v_HistoryId, Nullable<DateTime> d_StartDate, Nullable<DateTime> d_EndDate, String v_Organization, String v_TypeActivity, Nullable<Int32> i_GeografixcaHeight, String v_workstation, Nullable<DateTime> d_CreationDate, Nullable<DateTime> d_UpdateDate, Byte[] b_FingerPrintImage, Byte[] b_RubricImage, String t_RubricImageText, String v_TypeOperationName)
        {
