...
{
    [DataContract()]
    public partial class getvalorescomponente_observadoamc_spResultDto
    {
        [DataMember()]
        ...
        public getvalorescomponente_observadoamc_spResultDto()
        {
        }

        public getvalorescomponente_observadoamc_spResultDto(String v_ComponentFieldId, String v_ComponentFielName, String v_ServiceComponentFieldsId, String v_Value1, Nullable<Int32> i_GroupId)
        {
