...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    /// <summary>
    /// Assembler for <see cref="getcapsm_spResult"/> and <see cref="getcapsm_spResultDto"/>.
    /// </summary>
    public static partial class getcapsm_spResultAssembler
    {
        /// <summary>
        /// Invoked when <see cref="ToDTO"/> operation is about to return.
        /// </summary>
        /// <param name="dto"><see cref="getcapsm_spResultDto"/> converted from <see cref="getcapsm_spResult"/>.</param>
        static partial void OnDTO(this getcapsm_spResult entity, getcapsm_spResultDto dto);

        /// <summary>
        /// Invoked when <see cref="ToEntity"/> operation is about to return.
        /// </summary>
        /// <param name="entity"><see cref="getcapsm_spResult"/> converted from <see cref="getcapsm_spResultDto"/>.</param>
        static partial void OnEntity(this getcapsm_spResultDto dto, getcapsm_spResult entity);

        /// <summary>
        /// Converts this instance of <see cref="getcapsm_spResultDto"/> to an instance of <see cref="getcapsm_spResult"/>.
        /// </summary>
        /// <param name="dto"><see cref="getcapsm_spResultDto"/> to convert.</param>
        public static getcapsm_spResult ToEntity(this getcapsm_spResultDto dto)
        {
            if (dto == null) return null;

            var entity = new getcapsm_spResult();
        ...
        /// <summary>
        /// Converts this instance of <see cref="getcapsm_spResult"/> to an instance of <see cref="getcapsm_spResultDto"/>.
        /// </summary>
        /// <param name="entity"><see cref="getcapsm_spResult"/> to convert.</param>
        public static getcapsm_spResultDto ToDTO(this getcapsm_spResult entity)
        {
            if (entity == null) return null;

            var dto = new getcapsm_spResultDto();
        ...
        /// <summary>
        /// Converts each instance of <see cref="getcapsm_spResultDto"/> to an instance of <see cref="getcapsm_spResult"/>.
        /// </summary>
        /// <param name="dtos"></param>
        /// <returns></returns>
        public static List<getcapsm_spResult> ToEntities(this IEnumerable<getcapsm_spResultDto> dtos)
        {
        ...
        /// <summary>
        /// Converts each instance of <see cref="getcapsm_spResult"/> to an instance of <see cref="getcapsm_spResultDto"/>.
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
        public static List<getcapsm_spResultDto> ToDTOs(this IEnumerable<getcapsm_spResult> entities)
        {
