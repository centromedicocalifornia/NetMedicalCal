...
namespace Sigesoft.Common
{
    public class LiquidacionSegurosDetalle
    {
        public static void CreateLiquidacionSeguros(List<ServiciosDetalle> servicios, personDto dataPacient, organizationDto dataOrganization, organizationDto dataAseguradora, List<HospitalizacionCustom> dataHospitalizacion, DatosSeguuro dataSeguro, List<MeidicinasTicketsLista> tickets, List<RecetasDetalle> receta, string pathFile, decimal CostoConsultaDeducible)
        {
            ...
            string Servicio = "- - -", F_Servicio = "- - -", Plan = "- - -", Protocolo = "- - -", Solicitud = "- - -", Medico = "- - -", ConvenioFijado = "- - -";
            decimal Factor = 0, Descuento_PPS = 0, Deducible = 0, Coaseguro = 0, Habitacion = 0, CoaseguroFarGen = 0, CoaseguroFarCom = 0, Insumos = 0, ConvenioFijadoMonto = 0;
            if (dataSeguro != null)
            {
                ...
                CoaseguroFarGen = dataSeguro.CoaseguroFarGen;
                CoaseguroFarCom = dataSeguro.CoaseguroFarCom;
                Insumos = dataSeguro.Insumos;
                ConvenioFijado = dataSeguro.ConvenioFijado;
                ConvenioFijadoMonto = dataSeguro.ConvenioFijadoCosto;
            }
            #endregion
            //hospitalizacion
            int i_dias = 1;
            ...
            {                
                new PdfPCell(new Phrase("SEÑOR(ES)", fontColumnValueBold)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                ...
                new PdfPCell(new Phrase("H.C", fontColumnValueBold)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                ...
                new PdfPCell(new Phrase("DIRECCIÓN", fontColumnValue)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                new PdfPCell(new Phrase(orgAdress, fontColumnValue)) {Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                ...
                //new PdfPCell(new Phrase("", fontColumnValue)) {Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},

                new PdfPCell(new Phrase("PACIENTE", fontColumnValueBold)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                ...
                new PdfPCell(new Phrase("SOLC. / CART. GAR.", fontColumnValueBold)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                ...
                new PdfPCell(new Phrase("EMPPRESA CONTRATANTE", fontColumnValue)) {Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                ...
                new PdfPCell(new Phrase("FECHA DE INGRESO", fontColumnValueBold)) {Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                ...
                new PdfPCell(new Phrase(texto_Alta, fontColumnValueBold)) {Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                ...
                new PdfPCell(new Phrase("% INSUMOS", fontColumnValueBold)) {Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                new PdfPCell(new Phrase(": " + Insumos.ToString() + "%+", fontColumnValue)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                new PdfPCell(new Phrase("COASEGURO FAR_GEN", fontColumnValue)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                new PdfPCell(new Phrase(": " + CoaseguroFarGen.ToString() + "%", fontColumnValue)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                new PdfPCell(new Phrase("COASEGURO FAR_COM", fontColumnValue)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                new PdfPCell(new Phrase(": " + CoaseguroFarCom.ToString() + "%", fontColumnValue)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},

                new PdfPCell(new Phrase("CONVENIO FIJADO", fontColumnValue)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                new PdfPCell(new Phrase(": " + ConvenioFijado, fontColumnValue)) {Colspan = 3, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                ...
                new PdfPCell(new Phrase(ConvenioFijado == "- - -" ? ": - - -": ": " + Plan, fontColumnValue)) {Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},

                new PdfPCell(new Phrase("MEDICO A CARGO", fontColumnValueBold)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                ...
                new PdfPCell(new Phrase("", fontColumnValue)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
                new PdfPCell(new Phrase("CÓDIGO INTERNO", fontColumnValueBold)) {Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 16f, BorderColor = BaseColor.WHITE},
            ...
            if (ConvenioFijado != "- - -")
            {
                ...
                cells = new List<PdfPCell>()
                {
                    new PdfPCell(new Phrase("DETALLE DE LA ATENCIÓN", fontTitle2)) {Colspan = 4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 20f, BorderColor = BaseColor.BLACK},
                ...
                cells = new List<PdfPCell>()
                        {
                            new PdfPCell(new Phrase("", fontColumnValueBold)) {Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 25f, BorderColor = BaseColor.WHITE, BorderWidthTop = 0},
                    ...
                    foreach (var item in servicios)
                    {
                        ...
                        if (item.Lista1.Count >= 1 && item.Lista2 == null)
                        {
                            ...
                            foreach (var item1 in item.Lista1)
                            {
                                ...
                                cells.Add(cell);
                                cell = new PdfPCell(new Phrase("", fontColumnValue)) { Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 13f, BorderColor = BaseColor.WHITE };
                                cells.Add(cell);
        ...
        public static void CreateLiquidacionSegurosGlobal(List<ServiciosDetalle> servicios, personDto dataPacient, organizationDto dataOrganization, organizationDto dataAseguradora, List<HospitalizacionCustom> dataHospitalizacion, DatosSeguuro dataSeguro, List<MeidicinasTicketsLista> tickets, List<RecetasDetalle> receta, string pathFile, decimal CostoConsultaDeducible)
        {
            ...
            if (ConvenioFijado != "- - -")
            {
                ...
                decimal total = decimal.Round((habitacion + totalReceta + TotalServicios) * decimal.Parse(igv), 2);
