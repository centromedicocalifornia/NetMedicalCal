...
{
    [DataContract()]
    public partial class getservicedisgnosticsreports_spResultDto
    {
        [DataMember()]
        ...
        public getservicedisgnosticsreports_spResultDto()
        {
        }

        public getservicedisgnosticsreports_spResultDto(String v_DiagnosticRepositoryId, String v_ServiceId, String v_ComponentId, String v_DiseasesId, Nullable<Int32> i_AutoManualId, Nullable<Int32> i_PreQualificationId, Nullable<Int32> i_FinalQualificationId, Nullable<Int32> i_DiagnosticTypeId, Nullable<Int32> i_IsSentToAntecedent, Nullable<DateTime> d_ExpirationDateDiagnostic, Nullable<Int32> i_GenerateMedicalBreak, String v_ComponentFieldsId, String v_DiseasesName, String v_Cie10, String v_AutoManualName, String v_PreQualificationName, String v_FinalQualificationName, String v_DiagnosticTypeName, String v_IsSentToAntecedentName, Int32 i_RecordStatus, Int32 i_RecordType, String v_CreationUser, String v_UpdateUser, Nullable<DateTime> d_CreationDate, Nullable<DateTime> d_UpdateDate, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_CategoryId)
        {
