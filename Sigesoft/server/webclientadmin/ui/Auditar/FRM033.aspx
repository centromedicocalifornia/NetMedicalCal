...
<body>
    ...
    <x:Panel ID="Panel2" runat="server" Height="1420px" Width="1300px" ShowBorder="False"
        ...
        <Items>
                ...
                TableRowspan="1" runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="true" BoxConfigAlign="Stretch" AutoScroll="true">
                  <Items>
                        <x:GroupPanel runat="server" Title="Búsqueda / Filtro" ID="GroupPanel1" AutoWidth="true" BoxFlex="1" Height="90px" >                
                            <Items>
                                <x:Form ID="Form2" runat="server" EnableBackgroundColor="true" ShowBorder="False" ShowHeader="False" LabelWidth="110px" LabelAlign="Left">
                                        <Rows>
                                            <x:FormRow ID="FormRow1" ColumnWidths="460px" runat="server">
                                                <Items> 
                                                    <x:Form ID="Form3"   runat="server" EnableBackgroundColor="true" ShowBorder="False" ShowHeader="False" LabelWidth="50px" LabelAlign="Left">
                                                        <Rows>
                                                            <x:FormRow ID="FormRow2" ColumnWidths="450px" runat="server" >
                                                                <Items>
                                                                    ...
                                                                    <x:DropDownList ID="ddlEmpresaCliente" runat="server"  Label="Empresa" Width="290px"></x:DropDownList>  
                                                                </Items>
                                                            </x:FormRow>

                                                            <x:FormRow ColumnWidths="450px" runat="server" >
                                                                <Items>
                                                                    <x:DropDownList ID="ddlConsultorio" runat="server"  Label="Consultorio" Width="230px" AutoPostBack="true" OnSelectedIndexChanged="ddlConsultorio_SelectedIndexChanged"></x:DropDownList>  
                                                                    <x:TextBox  runat="server" Label="Trabaj." Text="" Width="200px" ID="txtTrabajador"></x:TextBox>     
                                          ...
                                          <Toolbars>
                                            <x:Toolbar ID="Toolbar4" runat="server">
                                                <Items>     
                                                    ...
                                                    <x:Button ID="btnNewFichaOcupacional" Text="Ficha Ocupacional" Icon="clipboard" runat="server" Enabled="false" OnClick="btnNewFichaOcupacional_Click"></x:Button>
                                                </Items>
                                            </x:Toolbar>
                                        </Toolbars>
                                        <Columns>
            ...
            <x:Panel ID="Panel3" Title="Diagnósticos" Width="1125px" Height="500px" EnableBackgroundColor="true" BoxConfigAlign="Top"
                 runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="true" Layout="Table" TableConfigColumns="1">
                <Items>
                   <x:Accordion ID="Accordion1" Title="Accordion Control" runat="server" Width="1100px" Height="280px"
                        EnableFill="true" ShowBorder="True" ActiveIndex="0">
                        <Panes>
                            <x:AccordionPane ID="AccordionPane1" runat="server" Title="Antecedentes" Icon="PageWhiteText" Width="400px"  AutoScroll="true"
                                BodyPadding="2px 5px" ShowBorder="false">
                                <Items>
                                  <x:Grid ID="grdAntecedentes" ShowBorder="true" ShowHeader="false" runat="server" Width="900px"  AutoScroll="true" Height="200px"
                                     EnableRowNumber="True" EnableRowNumberPaging="true" AutoHeight="true" RowNumberWidth="40" AjaxLoadingType="Default"
                      ...
                      <x:Panel ID="Panel6" runat="server"   ShowBorder="true" ShowHeader="false" Title=""  EnableBackgroundColor="true" Layout="Column" 
                              BoxConfigAlign="Top" BoxConfigPosition="Start" BoxConfigChildMargin="3 7 12 5" AutoScroll="true">
                                <Items>
                                    <x:Grid ID="grdDx" ShowBorder="true" ShowHeader="false" runat="server"  AutoScroll="true" Height="250px" Width="905px"
                                     EnableRowNumber="True" EnableRowNumberPaging="true" AutoHeight="true" RowNumberWidth="40" AjaxLoadingType="Default"
            ...
            <x:Panel Title="Recomendaciones / Restricciones" Width="1125px" Height="450px" EnableBackgroundColor="true"
                runat="server" BodyPadding="10px" ShowBorder="true" ShowHeader="true" Layout="Table" TableConfigColumns="1">
                <Items>

                      <x:Panel ID="Panel7" runat="server"   ShowBorder="true" ShowHeader="false" Title=""  EnableBackgroundColor="true" Layout="Column" 
                              BoxConfigAlign="Top" BoxConfigPosition="Start" BoxConfigChildMargin="3 7 12 5" AutoScroll="true">
                                <Items>
                                    <x:Grid ID="grdRecomendaciones" ShowBorder="true" ShowHeader="false" runat="server"  AutoScroll="true" Height="200" Width="900px"
                                     EnableRowNumber="True" EnableRowNumberPaging="true" AutoHeight="true" RowNumberWidth="40" AjaxLoadingType="Default"
                      ...
                      <x:Panel ID="Panel8" runat="server"   ShowBorder="true" ShowHeader="false" Title=""  EnableBackgroundColor="true" Layout="Column" 
                              BoxConfigAlign="Top" BoxConfigPosition="Start" BoxConfigChildMargin="3 7 12 5" AutoScroll="true">
                                <Items>
                                    <x:Grid ID="grdRestricciones" ShowBorder="true" ShowHeader="false" runat="server"  AutoScroll="true" Height="200" Width="900px"
                                     EnableRowNumber="True" EnableRowNumberPaging="true" AutoHeight="true" RowNumberWidth="40" AjaxLoadingType="Default"
