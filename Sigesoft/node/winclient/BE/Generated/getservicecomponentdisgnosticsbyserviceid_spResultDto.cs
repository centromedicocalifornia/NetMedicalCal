...
{
    [DataContract()]
    public partial class getservicecomponentdisgnosticsbyserviceid_spResultDto
    {
        [DataMember()]
        ...
        public getservicecomponentdisgnosticsbyserviceid_spResultDto()
        {
        }

        public getservicecomponentdisgnosticsbyserviceid_spResultDto(String v_DiagnosticRepositoryId, String v_ServiceId, String v_ComponentId, String v_ServiceComponentId, String v_DiseasesId, Nullable<Int32> i_AutoManualId, Nullable<Int32> i_PreQualificationId, Nullable<Int32> i_FinalQualificationId, Nullable<Int32> i_DiagnosticTypeId, Nullable<Int32> i_IsSentToAntecedent, Nullable<DateTime> d_ExpirationDateDiagnostic, Nullable<Int32> i_GenerateMedicalBreak, String v_DiseasesName, String v_AutoManualName, String v_ComponentName, String examen, String v_PreQualificationName, String v_FinalQualificationName, String v_DiagnosticTypeName, String v_IsSentToAntecedentName, Int32 i_RecordStatus, Int32 i_RecordType, String v_UpdateUser, Nullable<DateTime> d_UpdateDate, Nullable<Int32> i_IsDeleted, String v_RecomendationsName, String v_RestrictionsName, String aPTITUD_MTC)
        {
