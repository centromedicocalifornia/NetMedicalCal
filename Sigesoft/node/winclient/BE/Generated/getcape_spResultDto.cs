...
{
    [DataContract()]
    public partial class getcape_spResultDto
    {
        [DataMember()]
        ...
        public getcape_spResultDto()
        {
        }

        public getcape_spResultDto(String v_ServiceId, String v_FirstName, String v_FirstLastName, String v_SecondLastName, Byte[] b_Logo, String v_DocNumber, String v_DocTypeName, Nullable<DateTime> d_BirthDate, String v_GenderName, Nullable<Int32> i_EsoTypeId_Old, String v_OccupationName, String v_OrganizationPartialName, String v_ProtocolName, Nullable<Int32> i_AptitudeStatusId, Nullable<DateTime> d_ServiceDate, String v_DiseasesName, String v_DiagnosticRepositoryId, String grupo, String factor, Byte[] g_Image, String v_ObsStatusService, String empresaCliente)
        {
