...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class protocolDto
    {
        ...
        [DataMember()]
        public Nullable<Int32> i_mktWork { get; set; }

        [DataMember()]
        public Nullable<Int32> i_DateVald { get; set; }

        [DataMember()]
        public String v_DateVAR { get; set; }

        [DataMember()]
        public Nullable<Int32> i_TipoConvenio { get; set; }

        [DataMember()]
        public Nullable<Decimal> r_PrecioConvenio { get; set; }

        [DataMember()]
        public String v_NombreConvenio { get; set; }

        [DataMember()]
        public Nullable<Decimal> r_PrecioConsultaFijo { get; set; }

        [DataMember()]
        public Nullable<Decimal> r_PrecioConsultaEspecialidad1 { get; set; }

        [DataMember()]
        public Nullable<Decimal> r_PrecioConsultaEspecialidad2 { get; set; }

        [DataMember()]
        public Nullable<Decimal> r_PrecioConsultaEspecialidad3 { get; set; }
        ...
        public protocolDto(String v_ProtocolId, String v_Name, String v_EmployerOrganizationId, String v_EmployerLocationId, Nullable<Int32> i_EsoTypeId, String v_GroupOccupationId, String v_CustomerOrganizationId, String v_CustomerLocationId, String v_NombreVendedor, String v_WorkingOrganizationId, String v_WorkingLocationId, String v_CostCenter, Nullable<Int32> i_MasterServiceTypeId, Nullable<Int32> i_MasterServiceId, Nullable<Int32> i_HasVigency, Nullable<Int32> i_ValidInDays, Nullable<Int32> i_IsActive, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, String v_AseguradoraOrganizationId, String v_ComentaryUpdate, Nullable<Double> r_PriceFactor, Nullable<Double> r_MedicineDiscount, Nullable<Double> r_HospitalBedPrice, Nullable<Double> r_ClinicDiscount, Nullable<Double> r_DiscountExam, Nullable<Int32> i_Consultorio, String v_Procedencia, Nullable<Decimal> d_PrecioConsulta, Nullable<Decimal> d_DescuentoLaboratorio, Nullable<Decimal> d_DescuentoRayosX, Nullable<Decimal> d_DescuentoEcografias, Nullable<Decimal> d_DescuentoFarmacia, Nullable<Decimal> d_DescuentoOdontologia, Nullable<Decimal> d_CamaHosp, Nullable<Decimal> d_SalaOperaciones, Nullable<Decimal> d_PrecioAmbulancia, Nullable<Int32> i_mktWork, Nullable<Int32> i_DateVald, String v_DateVAR, Nullable<Int32> i_TipoConvenio, Nullable<Decimal> r_PrecioConvenio, String v_NombreConvenio, Nullable<Decimal> r_PrecioConsultaFijo, Nullable<Decimal> r_PrecioConsultaEspecialidad1, Nullable<Decimal> r_PrecioConsultaEspecialidad2, Nullable<Decimal> r_PrecioConsultaEspecialidad3, List<protocolcomponentDto> protocolcomponent, List<protocolsystemuserDto> protocolsystemuser, List<serviceDto> service, List<serviceorderdetailDto> serviceorderdetail)
        {
			...
			this.d_PrecioConsulta = d_PrecioConsulta;
			this.d_DescuentoLaboratorio = d_DescuentoLaboratorio;
			this.d_DescuentoRayosX = d_DescuentoRayosX;
			this.d_DescuentoEcografias = d_DescuentoEcografias;
			this.d_DescuentoFarmacia = d_DescuentoFarmacia;
			this.d_DescuentoOdontologia = d_DescuentoOdontologia;
			this.d_CamaHosp = d_CamaHosp;
			this.d_SalaOperaciones = d_SalaOperaciones;
			this.d_PrecioAmbulancia = d_PrecioAmbulancia;
			this.i_mktWork = i_mktWork;
			this.i_DateVald = i_DateVald;
			this.v_DateVAR = v_DateVAR;
			this.i_TipoConvenio = i_TipoConvenio;
			this.r_PrecioConvenio = r_PrecioConvenio;
			this.v_NombreConvenio = v_NombreConvenio;
			this.r_PrecioConsultaFijo = r_PrecioConsultaFijo;
			this.r_PrecioConsultaEspecialidad1 = r_PrecioConsultaEspecialidad1;
			this.r_PrecioConsultaEspecialidad2 = r_PrecioConsultaEspecialidad2;
			this.r_PrecioConsultaEspecialidad3 = r_PrecioConsultaEspecialidad3;
