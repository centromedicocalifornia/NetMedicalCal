...
{
    [DataContract()]
    public partial class getservicerecommendationbydiagnosticrepositoryid_spResultDto
    {
        [DataMember()]
        ...
        public getservicerecommendationbydiagnosticrepositoryid_spResultDto()
        {
        }

        public getservicerecommendationbydiagnosticrepositoryid_spResultDto(String v_RecommendationId, String v_DiagnosticRepositoryId, String v_ServiceId, String v_ComponentId, String v_MasterRecommendationId, String v_RestrictionName, Int32 i_RecordStatus, Int32 i_RecordType, String v_CreationUser, String v_UpdateUser, Nullable<DateTime> d_CreationDate, Nullable<DateTime> d_UpdateDate, Nullable<Int32> i_IsDeleted)
        {
