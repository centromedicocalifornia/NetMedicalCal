...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public static partial class hospitalizacionAssembler
    {
        ...
        public static hospitalizacion ToEntity(this hospitalizacionDto dto)
        {
            ...
            entity.i_PasoSop = dto.i_PasoSop;
            entity.i_PasoHosp = dto.i_PasoHosp;
            entity.v_DiseasesNameSalida = dto.v_DiseasesNameSalida;
            entity.v_CIE10IdSalida = dto.v_CIE10IdSalida;
            entity.v_FechaHoraInicioSop = dto.v_FechaHoraInicioSop;
            entity.v_FechaHoraFinSop = dto.v_FechaHoraFinSop;
            entity.d_FechaHoraInicioSop = dto.d_FechaHoraInicioSop;
            entity.d_FechaHoraFinSop = dto.d_FechaHoraFinSop;
            entity.i_TramaHosp = dto.i_TramaHosp;
            entity.i_TramaSop = dto.i_TramaSop;
        ...
        public static hospitalizacionDto ToDTO(this hospitalizacion entity)
        {
            ...
            dto.i_PasoSop = entity.i_PasoSop;
            dto.i_PasoHosp = entity.i_PasoHosp;
            dto.v_DiseasesNameSalida = entity.v_DiseasesNameSalida;
            dto.v_CIE10IdSalida = entity.v_CIE10IdSalida;
            dto.v_FechaHoraInicioSop = entity.v_FechaHoraInicioSop;
            dto.v_FechaHoraFinSop = entity.v_FechaHoraFinSop;
            dto.d_FechaHoraInicioSop = entity.d_FechaHoraInicioSop;
            dto.d_FechaHoraFinSop = entity.d_FechaHoraFinSop;
            dto.i_TramaHosp = entity.i_TramaHosp;
            dto.i_TramaSop = entity.i_TramaSop;
