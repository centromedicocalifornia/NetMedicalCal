...
namespace NetPdf
{
    public class FichaMedicaOcupacional312
    {
            ...
            string filePDF)
        {
            ...
            List<ServiceComponentFieldsList> Antropometria =
                ExamenesServicio.Find(a => a.v_ComponentId == "N002-ME000000002") == null
                    ? new List<ServiceComponentFieldsList>()
                    : ExamenesServicio.Find(a => a.v_ComponentId == "N002-ME000000002").ServiceComponentFields;
            List<ServiceComponentFieldsList> FuncionesVitales =
                ExamenesServicio.Find(a => a.v_ComponentId == "N002-ME000000001") == null
                    ? new List<ServiceComponentFieldsList>()
                    : ExamenesServicio.Find(a => a.v_ComponentId == "N002-ME000000001").ServiceComponentFields;
            List<ServiceComponentFieldsList> ExamenFisco =
                ExamenesServicio.Find(a => a.v_ComponentId == "N002-ME000000022") == null
                    ? new List<ServiceComponentFieldsList>()
                    : ExamenesServicio.Find(a => a.v_ComponentId == "N002-ME000000022").ServiceComponentFields;
            List<ServiceComponentFieldsList> Oftalmologia =
                ExamenesServicio.Find(a => a.v_ComponentId == "N002-ME000000028") == null
                    ? new List<ServiceComponentFieldsList>()
                    : ExamenesServicio.Find(a => a.v_ComponentId == "N002-ME000000028").ServiceComponentFields;
            List<ServiceComponentFieldsList> Laboratorio =
                ExamenesServicio.Find(a => a.v_ComponentId == "N001-ME000000000") == null
                    ? new List<ServiceComponentFieldsList>()
                    : ExamenesServicio.Find(a => a.v_ComponentId == "N001-ME000000000").ServiceComponentFields;

            List<ServiceComponentFieldsList> Psicologia =
                ExamenesServicio.Find(a => a.v_ComponentId == "N002-ME000000033") == null
                    ? new List<ServiceComponentFieldsList>()
                    : ExamenesServicio.Find(a => a.v_ComponentId == "N002-ME000000033").ServiceComponentFields;
            List<ServiceComponentFieldsList> OIT =
                ExamenesServicio.Find(a => a.v_ComponentId == "N009-ME000000062") == null
                    ? new List<ServiceComponentFieldsList>()
                    : ExamenesServicio.Find(a => a.v_ComponentId == "N009-ME000000062").ServiceComponentFields;
            List<ServiceComponentFieldsList> RX =
                ExamenesServicio.Find(a => a.v_ComponentId == "N002-ME000000032") == null
                    ? new List<ServiceComponentFieldsList>()
                    : ExamenesServicio.Find(a => a.v_ComponentId == "N002-ME000000032").ServiceComponentFields;
            List<ServiceComponentFieldsList> Espirometria =
                ExamenesServicio.Find(a => a.v_ComponentId == "N002-ME000000031") == null
                    ? new List<ServiceComponentFieldsList>()
                    : ExamenesServicio.Find(a => a.v_ComponentId == "N002-ME000000031").ServiceComponentFields;
            ...
            //cells.Add(CellLogo);
            cells.Add(new PdfPCell(table) {Colspan = 2});
            ...
            if (DataService != null)
            {
                ...
                {
                    cells.Add(new PdfPCell(new Phrase("ESTE EXAMEN NO APLICA AL PROTOCOLO DE ATENCIÓN.",
                        fontColumnValue)));
                    DNI = "X";
                }
                ...
                cells = new List<PdfPCell>()
                {
                    ...
                    //fila
                    new PdfPCell(new Phrase("DISTRITO: ", fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_RIGHT},
                    new PdfPCell(new Phrase(DataService.DistritoPaciente, fontColumnValue))
                        {Colspan = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT},
                    new PdfPCell(new Phrase("PROVINCIA: ", fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_RIGHT},
                    ...
                    new PdfPCell(new Phrase("CORREO ELECTRÓNICO: ", fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_RIGHT},
                    new PdfPCell(
                            new Phrase(DataService.Email == "" ? "NO REFIERE" : DataService.Email, fontColumnValue))
                        {Colspan = 5, HorizontalAlignment = PdfPCell.ALIGN_LEFT},
            ...
            if (listAtecedentesOcupacionales != null && listAtecedentesOcupacionales.Count > 0)
            {
                ...
                {
                    //Columna EMPRESA
                    cell = new PdfPCell(new Phrase(item.v_Organization, fontColumnValueAntecedentesOcupacionales))
                        {HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE};
                    cells.Add(cell);

                    //Columna ÁREA
                    cell = new PdfPCell(new Phrase(item.v_TypeActivity, fontColumnValueAntecedentesOcupacionales))
                        {HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE};
                    cells.Add(cell);

                    //Columna OCUPACIÓN
                    cell = new PdfPCell(new Phrase(
                            item.i_Trabajo_Actual == 1 ? item.v_workstation + " Puesto Actual " : item.v_workstation,
                            fontColumnValue))
                        {HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE};
                    cells.Add(cell);
                    ...
                    cells1.Add(new PdfPCell(new Phrase(item.d_StartDate.Value.ToString("MM/yyyy"),
                        fontColumnValueAntecedentesOcupacionales)));

                    cells1.Add(new PdfPCell(new Phrase("FECHA FIN: ", fontColumnValueAntecedentesOcupacionales)));
                    cells1.Add(new PdfPCell(new Phrase(item.d_EndDate.Value.ToString("MM/yyyy"),
                        fontColumnValueAntecedentesOcupacionales)));
                    ...
                    //Columna EXPOSICIÓN
                    cell = new PdfPCell(new Phrase(
                            item.Exposicion == "" ? "NO REFIERE PELIGROS EN EL PUESTO" : item.Exposicion,
                            fontColumnValueAntecedentesOcupacionales))
                        {HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE};
                    cells.Add(cell);

                    //Columna TIPO OPERACIÓN
                    cell = new PdfPCell(new Phrase(item.TiempoLabor, fontColumnValueAntecedentesOcupacionales))
                        {HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE};
                    cells.Add(cell);

                    //Columna EPPS
                    cell = new PdfPCell(new Phrase(item.Epps == "" ? "NO USÓ EPP" : item.Epps,
                            fontColumnValueAntecedentesOcupacionales))
                        {HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE};
                    cells.Add(cell);
                }
            ...
            table = HandlingItextSharp.GenerateTableFromCells(cells, columnWidths, "III. ANTECEDENTES OCUPACIONALES",
                fontTitleTableAntecedentesOcupacionales, columnHeaders);
            ...
            var Alergia =
                listMedicoPersonales.FindAll(p => p.v_DiseasesId == Sigesoft.Common.Constants.ALERGIA_NO_ESPECIFICADA);
            var Diabetess =
                listMedicoPersonales.FindAll(p => p.v_DiseasesId == Sigesoft.Common.Constants.DIABETES_MELLITUS);
            ...
            var Convulsiones =
                listMedicoPersonales.FindAll(p => p.v_DiseasesId == Sigesoft.Common.Constants.CONVULSIONES);
            ...
            var Intoxicaciones =
                listMedicoPersonales.FindAll(p => p.v_DiseasesId == Sigesoft.Common.Constants.INTOXICACIONES);
            ...
            if (Alergia.Count == 0 && Diabetess.Count == 0 && TBC.Count == 0 && Hepatitis.Count == 0 &&
                Hepatitis.Count == 0
            ...
            filiationWorker = HandlingItextSharp.GenerateTableFromCells(cells, columnWidths,
                "IV. ANTECEDENTES PATOLÓGICOS PERSONALES" + noRefiereAP, fontTitleTable);
            ...
            List<NoxiousHabitsList> Medicamentos = null;
            ...
            cells = new List<PdfPCell>()
            {
                ...
                new PdfPCell(new Phrase(Alcohol == null || Alcohol.Count == 0 ? string.Empty : Alcohol[0].v_Frequency,
                    fontColumnValue)),
                ...
                new PdfPCell(new Phrase(Tabaco == null || Tabaco.Count == 0 ? string.Empty : Tabaco[0].v_Frequency,
                    fontColumnValue)),
                ...
                new PdfPCell(new Phrase(Drogas == null || Drogas.Count == 0 ? string.Empty : Drogas[0].v_Frequency,
                    fontColumnValue)),
            ...
            if (listaPatologicosFamiliares != null && listaPatologicosFamiliares.Count > 0)
            {
                ...
                //Columna FAMILIAR
                cell = new PdfPCell(new Phrase("PADRE", fontColumnValue))
                    {HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE};
                cells.Add(cell);
                var PadreDx =
                    listaPatologicosFamiliares.FindAll(p =>
                        p.i_TypeFamilyId == (int) Sigesoft.Common.TypeFamily.PADRE_OK);


                // Crear tabla de recomendaciones para insertarla en la celda que corresponde
                table = HandlingItextSharp.GenerateTableFromList(PadreDx.Count == 0 ? ListaVacia : PadreDx,
                    columnWidths, include, fontColumnValue);
                cell = new PdfPCell(table);
                cells.Add(cell);


                //Columna FAMILIAR
                cell = new PdfPCell(new Phrase("MADRE", fontColumnValue))
                    {HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE};
                cells.Add(cell);
                var MadreDx =
                    listaPatologicosFamiliares.FindAll(p =>
                        p.i_TypeFamilyId == (int) Sigesoft.Common.TypeFamily.MADRE_OK);
                // Crear tabla de recomendaciones para insertarla en la celda que corresponde
                table = HandlingItextSharp.GenerateTableFromList(MadreDx.Count == 0 ? ListaVacia : MadreDx,
                    columnWidths, include, fontColumnValue);
                cell = new PdfPCell(table);
                cells.Add(cell);
                ...
                //Columna FAMILIAR
                cell = new PdfPCell(new Phrase("HERMANOS", fontColumnValue))
                    {HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE};
                cells.Add(cell);
                var HermanosDx = listaPatologicosFamiliares.FindAll(p =>
                    p.i_TypeFamilyId == (int) Sigesoft.Common.TypeFamily.HERMANOS_OK);
                // Crear tabla de recomendaciones para insertarla en la celda que corresponde
                table = HandlingItextSharp.GenerateTableFromList(HermanosDx.Count == 0 ? ListaVacia : HermanosDx,
                    columnWidths, include, fontColumnValue);
                cell = new PdfPCell(table);
                cells.Add(cell);

                //Columna FAMILIAR
                cell = new PdfPCell(new Phrase("ESPOSO(A)", fontColumnValue))
                    {HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE};
                cells.Add(cell);
                var EspososDx = listaPatologicosFamiliares.FindAll(p =>
                    p.i_TypeFamilyId == (int) Sigesoft.Common.TypeFamily.ABUELOS_OK);
                // Crear tabla de recomendaciones para insertarla en la celda que corresponde
                table = HandlingItextSharp.GenerateTableFromList(EspososDx.Count == 0 ? ListaVacia : EspososDx,
                    columnWidths, include, fontColumnValue);
                cell = new PdfPCell(table);
                cells.Add(cell);
                ...
                var HijosDx =
                    listaPatologicosFamiliares.FindAll(p =>
                        p.i_TypeFamilyId == (int) Sigesoft.Common.TypeFamily.HIJOS_OK);
                // Crear tabla de recomendaciones para insertarla en la celda que corresponde
                table = HandlingItextSharp.GenerateTableFromList(EspososDx.Count == 0 ? ListaVacia : HijosDx,
                    columnWidths, include, fontColumnValue);
                cell = new PdfPCell(table);
                cells.Add(cell);
            ...
            table = HandlingItextSharp.GenerateTableFromCells(cells, columnWidths,
                "V. ANTECEDENTES PATOLÓGICOS FAMILIARES" + noRefiere, fontTitleTable, null);
            ...
            if (DataService != null)
            {
                ...
                {
                    //fila
                    new PdfPCell(new Phrase("Nro. HIJOS VIVOS", fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_RIGHT},
                    new PdfPCell(new Phrase(DataService.HijosVivos == null ? "" : DataService.HijosVivos.ToString(),
                        fontColumnValue)) {HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                    new PdfPCell(new Phrase("NRO. HIJOS MUERTOS", fontColumnValue))
                        {Colspan = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT},
                    new PdfPCell(new Phrase(
                        DataService.HijosDependientes == null ? "" : DataService.HijosDependientes.ToString(),
                        fontColumnValue)) {HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                    new PdfPCell(new Phrase("Nro. HERMANOS", fontColumnValue))
                        {Colspan = 2, HorizontalAlignment = PdfPCell.ALIGN_RIGHT},
                    new PdfPCell(new Phrase(
                            DataService.i_NroHermanos == null ? "" : DataService.i_NroHermanos.ToString(),
                            fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_LEFT},
            ...
            foreach (var item in listMedicoPersonales)
            {
                cell = new PdfPCell(new Phrase(item.v_DiseasesName, fontColumnValue))
                    {HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_LEFT};
                cells.Add(cell);

                if (item.i_TypeDiagnosticId == (int) Sigesoft.Common.TipoDx.Accidente_Ocupacional ||
                    item.i_TypeDiagnosticId == (int) Sigesoft.Common.TipoDx.Enfermedad_Ocupacional)
                {
                    cell = new PdfPCell(new Phrase("X", fontColumnValue))
                        {HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE};
                    cells.Add(cell);
                ...
                cell = new PdfPCell(new Phrase(
                        item.d_StartDate == null ? string.Empty : item.d_StartDate.Value.ToString("yyyy").ToString(),
                        fontColumnValue))
                    {HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE};
                cells.Add(cell);
            ...
            table = HandlingItextSharp.GenerateTableFromCells(cellsTit1, columnWidths, PdfPCell.NO_BORDER, null,
                fontTitleTable);
            ...
            //Antropometria
            string Talla =
                ((ServiceComponentFieldsList) Antropometria.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_TALLA_ID)) == null
                    ? string.Empty
                    : ((ServiceComponentFieldsList) Antropometria.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_TALLA_ID)).v_Value1;
            string Peso =
                ((ServiceComponentFieldsList) Antropometria.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_PESO_ID)) == null
                    ? string.Empty
                    : ((ServiceComponentFieldsList) Antropometria.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_PESO_ID)).v_Value1;
            string IMC =
                ((ServiceComponentFieldsList) Antropometria.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_IMC_ID)) == null
                    ? string.Empty
                    : ((ServiceComponentFieldsList) Antropometria.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_IMC_ID)).v_Value1;
            string ICC =
                ((ServiceComponentFieldsList) Antropometria.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_INDICE_CINTURA_ID)) == null
                    ? string.Empty
                    : ((ServiceComponentFieldsList) Antropometria.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_INDICE_CINTURA_ID)).v_Value1;
            string PerimetroCadera =
                ((ServiceComponentFieldsList) Antropometria.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_PERIMETRO_CADERA_ID)) == null
                    ? string.Empty
                    : ((ServiceComponentFieldsList) Antropometria.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_PERIMETRO_CADERA_ID)).v_Value1;
            string PerimetroAbdominal =
                ((ServiceComponentFieldsList) Antropometria.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_PERIMETRO_ABDOMINAL_ID)) == null
                    ? string.Empty
                    : ((ServiceComponentFieldsList) Antropometria.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_PERIMETRO_ABDOMINAL_ID))
                    .v_Value1;
            string PorcentajeGrasaCorporal =
                ((ServiceComponentFieldsList) Antropometria.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_PORCENTAJE_GRASA_CORPORAL_ID)) ==
                null
                    ? string.Empty
                    : ((ServiceComponentFieldsList) Antropometria.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ANTROPOMETRIA_PORCENTAJE_GRASA_CORPORAL_ID))
            ...
            //Funciones Vitales
            string FrecResp =
                ((ServiceComponentFieldsList) FuncionesVitales.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_FREC_RESPIRATORIA_ID)) == null
                    ? string.Empty
                    : ((ServiceComponentFieldsList) FuncionesVitales.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_FREC_RESPIRATORIA_ID))
                    .v_Value1;
            string frecCard =
                ((ServiceComponentFieldsList) FuncionesVitales.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_FREC_CARDIACA_ID)) == null
                    ? string.Empty
                    : ((ServiceComponentFieldsList) FuncionesVitales.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_FREC_CARDIACA_ID))
                    .v_Value1;
            string PAD =
                ((ServiceComponentFieldsList) FuncionesVitales.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_PAD_ID)) == null
                    ? string.Empty
                    : ((ServiceComponentFieldsList) FuncionesVitales.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_PAD_ID)).v_Value1;
            string PAS =
                ((ServiceComponentFieldsList) FuncionesVitales.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_PAS_ID)) == null
                    ? string.Empty
                    : ((ServiceComponentFieldsList) FuncionesVitales.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_PAS_ID)).v_Value1;
            string Temperatura =
                ((ServiceComponentFieldsList) FuncionesVitales.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_TEMPERATURA_ID)) == null
                    ? string.Empty
                    : ((ServiceComponentFieldsList) FuncionesVitales.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_TEMPERATURA_ID)).v_Value1;
            string SaturacionOxigeno =
                ((ServiceComponentFieldsList) FuncionesVitales.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_SAT_O2_ID)) == null
                    ? string.Empty
                    : ((ServiceComponentFieldsList) FuncionesVitales.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.FUNCIONES_VITALES_SAT_O2_ID)).v_Value1;
            ...
            ConcatenadoOtros = ConcatenadoOtros == ""
                ? string.Empty
                : ConcatenadoOtros.Substring(0, ConcatenadoOtros.Length - 2);
            //Examen fisico
            //string Estoscopia = "";
            ...
            //{
            string Estoscopia =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_ECTOSCOPIA_GENERAL_DESCRIPCION_ID)
                ) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_FISICO_ECTOSCOPIA_GENERAL_DESCRIPCION_ID)).v_Value1;
            //}
            ...
            string Estado_Mental =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_ESTADO_METAL_DESCRIPCION_ID)) ==
                null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_ESTADO_METAL_DESCRIPCION_ID))
            ...
            string Piel =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_PIEL_DESCRIPCION_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_PIEL_DESCRIPCION_ID)).v_Value1;
            string PielHallazgo =
                ExamenFisco.Count() == 0 ||
                (ExamenFisco.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_PIEL_ID)) ==
                null
                    ? string.Empty
                    : (ExamenFisco.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_PIEL_ID))
                    .v_Value1;
            ...
            string Cabello =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_CABELLO_DESCRIPCION_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_CABELLO_DESCRIPCION_ID))
                    .v_Value1;
            string CabelloHallazgo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_CABELLO_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(
                        p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_CABELLO_ID)).v_Value1;
            if (CabelloHallazgo == ((int) Sigesoft.Common.NormalAlteradoHallazgo.SinHallazgos).ToString())
                CabelloX = "X";
            ...
            string Oido =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_OIDOS_DESCRIPCION_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_OIDOS_DESCRIPCION_ID))
                    .v_Value1;
            string OidoHallazgo =
                ExamenFisco.Count() == 0 ||
                (ExamenFisco.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_OIDOS_ID)) ==
                null
                    ? string.Empty
                    : (ExamenFisco.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_OIDOS_ID))
                    .v_Value1;
            ...
            string Nariz =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_NARIZ_DESCRIPCION_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_NARIZ_DESCRIPCION_ID))
                    .v_Value1;
            string NarizHallazgo =
                ExamenFisco.Count() == 0 ||
                (ExamenFisco.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_NARIZ_ID)) ==
                null
                    ? string.Empty
                    : (ExamenFisco.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_NARIZ_ID))
                    .v_Value1;
            ...
            string Boca =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_BOCA_DESCRIPCION_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_BOCA_DESCRIPCION_ID)).v_Value1;
            string BocaHallazgo =
                ExamenFisco.Count() == 0 ||
                (ExamenFisco.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_BOCA_ID)) ==
                null
                    ? string.Empty
                    : (ExamenFisco.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_BOCA_ID))
                    .v_Value1;
            ...
            string Faringe =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_FARINGE_DESCRIPCION_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_FARINGE_DESCRIPCION_ID))
                    .v_Value1;
            string FaringeHallazgo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_FARINGE_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(
                        p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_FARINGE_ID)).v_Value1;
            if (FaringeHallazgo == ((int) Sigesoft.Common.NormalAlteradoHallazgo.SinHallazgos).ToString())
                FaringeX = "X";
            ...
            string Cuello =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_CUELLO_DESCRIPCION_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_CUELLO_DESCRIPCION_ID))
                    .v_Value1;
            string CuelloHallazgo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_CUELLO_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_CUELLO_ID)).v_Value1;
            if (CuelloHallazgo == ((int) Sigesoft.Common.NormalAlteradoHallazgo.SinHallazgos).ToString()) CuelloX = "X";


            string ApaRespiratorioX = "";
            string ApaRespiratorio =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId ==
                    Sigesoft.Common.Constants.EXAMEN_FISICO_APARATO_RESPIRATORIO_DESCRIPCION_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_FISICO_APARATO_RESPIRATORIO_DESCRIPCION_ID)).v_Value1;
            string ApaRespiratorioHallazgo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_APARATORESPIRATORIO_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_APARATORESPIRATORIO_ID))
                    .v_Value1;
            if (ApaRespiratorioHallazgo == ((int) Sigesoft.Common.NormalAlteradoHallazgo.SinHallazgos).ToString())
                ApaRespiratorioX = "X";


            string ApaCardioVascularX = "";
            string ApaCardioVascular =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_CARDIO_VASCULAR_DESCRIPCION_ID)) ==
                null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_FISICO_CARDIO_VASCULAR_DESCRIPCION_ID)).v_Value1;
            string ApaCardioVascularHallazgo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_CARDIO_VASCULAR_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_CARDIO_VASCULAR_ID)).v_Value1;
            if (ApaCardioVascularHallazgo == ((int) Sigesoft.Common.NormalAlteradoHallazgo.SinHallazgos).ToString())
                ApaCardioVascularX = "X";


            string ApaDigestivoX = "";
            string ApaDigestivo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_APARATO_DIGESTIVO_DESCRIPCION_ID)
                ) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_FISICO_APARATO_DIGESTIVO_DESCRIPCION_ID)).v_Value1;
            string ApaDigestivoHallazgo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_APARATO_DIGESTIVO_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_APARATO_DIGESTIVO_ID))
                    .v_Value1;
            if (ApaDigestivoHallazgo == ((int) Sigesoft.Common.NormalAlteradoHallazgo.SinHallazgos).ToString())
                ApaDigestivoX = "X";
            ...
            string ApaGenitoUrinario =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId ==
                    Sigesoft.Common.Constants.EXAMEN_FISICO_APARATO_GENITOURINARIO_DESCRIPCION_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_FISICO_APARATO_GENITOURINARIO_DESCRIPCION_ID)).v_Value1;
            string ApaGenitoUrinarioHallazgo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_GENITOURINARIO_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_GENITOURINARIO_ID)).v_Value1;
            if (ApaGenitoUrinarioHallazgo == ((int) Sigesoft.Common.NormalAlteradoHallazgo.SinHallazgos).ToString())
                ApaGenitoUrinarioX = "X";
            ...
            if (DataService != null)
            {
                ...
                if (sex == (int?) Sigesoft.Common.Gender.FEMENINO)
                {
                    ApaGenitoUrinario = string.Format("MENARQUIA: {0} ," +
                                                      ...
                                                      "MAC: {4} ," +
                                                      "CIRUGÍA GINECOLÓGICA: {5}",
                        string.IsNullOrEmpty(DataService.v_Menarquia) ? "NO REFIERE" : DataService.v_Menarquia,
                        DataService.d_Fur == null ? "NO REFIERE" : DataService.d_Fur.Value.ToShortDateString(),
                        string.IsNullOrEmpty(DataService.v_CatemenialRegime)
                            ? "NO REFIERE"
                            : DataService.v_CatemenialRegime,
            ...
            string ApaLocomotor =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_APARATO_LOCOMOTOR_DESCRIPCION_ID)
                ) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_FISICO_APARATO_LOCOMOTOR_DESCRIPCION_ID)).v_Value1;
            string ApaLocomotorHallazgo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_APARATO_LOCOMOTOR_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_APARATO_LOCOMOTOR_ID))
                    .v_Value1;
            if (ApaLocomotorHallazgo == ((int) Sigesoft.Common.NormalAlteradoHallazgo.SinHallazgos).ToString())
                ApaLocomotorX = "X";
            ...
            string Marcha =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_MARCHA_DESCRIPCION_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_MARCHA_DESCRIPCION_ID))
                    .v_Value1;
            string MarchaHallazgo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_MARCHA_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_MARCHA_ID)).v_Value1;
            ...
            string Columna =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_COLUMNA_DESCRIPCION_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_COLUMNA_DESCRIPCION_ID))
                    .v_Value1;
            string ColumnaHallazgo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_COLMNA_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_COLMNA_ID)).v_Value1;
            if (ColumnaHallazgo == ((int) Sigesoft.Common.NormalAlteradoHallazgo.SinHallazgos).ToString())
                ColumnaX = "X";
            ...
            string Superiores =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId ==
                    Sigesoft.Common.Constants.EXAMEN_FISICO_EXTREMIDADES_SUPERIORES_DESCRIPCION_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EXAMEN_FISICO_EXTREMIDADES_SUPERIORES_DESCRIPCION_ID)).v_Value1;
            string SuperioresHallazgo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_EXTREMIDADE_SUPERIORES_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_EXTREMIDADE_SUPERIORES_ID))
                    .v_Value1;
            if (SuperioresHallazgo == ((int) Sigesoft.Common.NormalAlteradoHallazgo.SinHallazgos).ToString())
                SuperioresX = "X";
            ...
            string Inferiores =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId ==
                    Sigesoft.Common.Constants.EXAMEN_FISICO_EXTREMIDADES_INFERIORES_DESCRIPCION_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EXAMEN_FISICO_EXTREMIDADES_INFERIORES_DESCRIPCION_ID)).v_Value1;
            string InferioresHallazgo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_EXTREMIDADES_INFERIORES_ID)) ==
                null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_EXTREMIDADES_INFERIORES_ID))
                    .v_Value1;
            if (InferioresHallazgo == ((int) Sigesoft.Common.NormalAlteradoHallazgo.SinHallazgos).ToString())
                InferioresX = "X";
            ...
            string SistemaLinfatico =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_LINFATICOS_DESCRIPCION_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_LINFATICOS_DESCRIPCION_ID))
                    .v_Value1;
            string SistemaLinfaticoHallazgo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_LINFATICOS_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_LINFATICOS_ID)).v_Value1;
            if (SistemaLinfaticoHallazgo == ((int) Sigesoft.Common.NormalAlteradoHallazgo.SinHallazgos).ToString())
                SistemaLinfaticoX = "X";
            ...
            string SistemaNervioso =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_SISTEMA_NERVIOSO_DESCRIPCION_ID)
                ) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_FISICO_SISTEMA_NERVIOSO_DESCRIPCION_ID)).v_Value1;
            string SistemaNerviosoHallazgo =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_SISTEMA_NERVIOSO_ID)) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_SISTEMA_NERVIOSO_ID)).v_Value1;
            if (SistemaNerviosoHallazgo == ((int) Sigesoft.Common.NormalAlteradoHallazgo.SinHallazgos).ToString())
                SistemaNerviosoX = "X";



            string Hallazgos =
                Oftalmologia.Count() == 0 || (Oftalmologia.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.OFTALMOLOGIA_HALLAZGOS_ID)) == null
                    ? string.Empty
                    : (Oftalmologia.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.OFTALMOLOGIA_HALLAZGOS_ID)).v_Value1;
            ...
            cells = new List<PdfPCell>()
            {
                ...
                new PdfPCell(new Phrase(
                    Temperatura == "0.0" || Temperatura == "0,0" || string.IsNullOrEmpty(Temperatura)
                        ? ""
                        : double.Parse(Temperatura).ToString("#.#"), fontColumnValue)),
                ...
                new PdfPCell(new Phrase(ApaRespiratorioX, fontColumnValue))
                    {HorizontalAlignment = PdfPCell.ALIGN_CENTER},
                ...
                new PdfPCell(new Phrase(ApaCardioVascularX, fontColumnValue))
                    {HorizontalAlignment = PdfPCell.ALIGN_CENTER},
                ...
                new PdfPCell(new Phrase(ApaGenitoUrinarioX, fontColumnValue))
                    {HorizontalAlignment = PdfPCell.ALIGN_CENTER},
                ...
                new PdfPCell(new Phrase(SistemaLinfaticoX, fontColumnValue))
                    {HorizontalAlignment = PdfPCell.ALIGN_CENTER},
                new PdfPCell(new Phrase(SistemaLinfatico, fontColumnValue))
                    {Colspan = 4, HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                new PdfPCell(new Phrase("SISTEMA NERVIOSO", fontColumnValue)),
                new PdfPCell(new Phrase(SistemaNerviosoX, fontColumnValue))
                    {HorizontalAlignment = PdfPCell.ALIGN_CENTER},
            ...
            filiationWorker = HandlingItextSharp.GenerateTableFromCells(cells, columnWidths,
                "VI. EVALUACIÓN MÉDICA (LLENAR CON LETRA CLARA O MARCAR CON UNA 'X')", fontTitleTable);
            ...
            ServiceComponentList apendice2Yanacocha = serviceComponent.Find(p =>
                p.v_ComponentId == Sigesoft.Common.Constants.APENDICE_N_2_EVALUACION_OFTALMOLOGICA_YANACOCHA_ID);
            ServiceComponentList informeOftalmoSimple = serviceComponent.Find(p =>
                p.v_ComponentId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_ID);
            ServiceComponentList informeOftalmoCompleto = serviceComponent.Find(p =>
                p.v_ComponentId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_ID);
            ServiceComponentList informeOftalmoHudbay = serviceComponent.Find(p =>
                p.v_ComponentId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_ID);
            ServiceComponentList findOftalmologia =
                serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.OFTALMOLOGIA_ID);
            ...
            string vcscod = "",
                ...
                presionIntraOcOI = "",
                flyTest = "";
            string ValorReflejosPupilares = "",
                ValorEnfermedadesOculares = "",
                ValorFondoDeOjo = "",
                ValorTonometria = "";
            ...
            if (apendice2Yanacocha != null)
            {
                ...
                vcscod = apendice2Yanacocha.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                 .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VCSCOD) == null
                    ? "FALTA LLENAR"
                    : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VCSCOD).v_Value1Name;
                vcscoi = apendice2Yanacocha.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                 .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VCSCOI) == null
                    ? "FALTA LLENAR"
                    : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VCSCOI).v_Value1Name;
                vcccod = apendice2Yanacocha.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                 .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VCCCOD) == null
                    ? "FALTA LLENAR"
                    : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VCCCOD).v_Value1Name;
                vcccoi = apendice2Yanacocha.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                 .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VCCCOI) == null
                    ? "FALTA LLENAR"
                    : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VCCCOI).v_Value1Name;

                vlscod = apendice2Yanacocha.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                 .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VLSCOD) == null
                    ? "FALTA LLENAR"
                    : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VLSCOD).v_Value1Name;
                vlscoi = apendice2Yanacocha.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                 .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VLSCOI) == null
                    ? "FALTA LLENAR"
                    : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VLSCOI).v_Value1Name;
                vlccod = apendice2Yanacocha.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                 .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VLCCOD) == null
                    ? "FALTA LLENAR"
                    : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VLCCOD).v_Value1Name;
                vlccoi = apendice2Yanacocha.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                 .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VLCCOI) == null
                    ? "FALTA LLENAR"
                    : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_VLCCOI).v_Value1Name;

                enfermedadesOculares =
                    apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_ENFERMEDADES_OCULARES) == null
                        ? "FALTA LLENAR"
                        : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_ENFERMEDADES_OCULARES).v_Value1;

                testIshihara =
                    apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_TEST_ISHIHARA) == null
                        ? "FALTA LLENAR"
                        : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_TEST_ISHIHARA).v_Value1Name;
                reflejosPupilares =
                    apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_REFLEJOS_PUPILARES) == null
                        ? "FALTA LLENAR"
                        : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_REFLEJOS_PUPILARES).v_Value1Name;

                maculaOD =
                    apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_MACULA_OD) == null
                        ? "FALTA LLENAR"
                        : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_MACULA_OD).v_Value1Name;
                maculaOI =
                    apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_MACULA_OI) == null
                        ? "FALTA LLENAR"
                        : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_MACULA_OI).v_Value1Name;
                nervioOpticoOD =
                    apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_NERVIO_OPTICO_OD) == null
                        ? "FALTA LLENAR"
                        : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_NERVIO_OPTICO_OD).v_Value1Name;
                nervioOpticoOI =
                    apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_NERVIO_OPTICO_OI) == null
                        ? "FALTA LLENAR"
                        : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_NERVIO_OPTICO_OI).v_Value1Name;
                retinaOD =
                    apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_RETINA_OD) == null
                        ? "FALTA LLENAR"
                        : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_RETINA_OD).v_Value1Name;
                retinaOI =
                    apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_RETINA_OI) == null
                        ? "FALTA LLENAR"
                        : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_RETINA_OI).v_Value1Name;

                presionIntraOcOD =
                    apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_PRESION_INTRAOCULAR_OD) == null
                        ? "FALTA LLENAR"
                        : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_PRESION_INTRAOCULAR_OD).v_Value1;
                presionIntraOcOI =
                    apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_PRESION_INTRAOCULAR_OI) == null
                        ? "FALTA LLENAR"
                        : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_PRESION_INTRAOCULAR_OI).v_Value1;
                string npresionIntraOcODMed =
                    apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_PRESION_INTRAOCULAR_OD) == null
                        ? "FALTA LLENAR"
                        : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                    .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_PRESION_INTRAOCULAR_OD)
                            .v_MeasurementUnitName;
                string presionIntraOcOIMed =
                    apendice2Yanacocha.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_PRESION_INTRAOCULAR_OI) == null
                        ? "FALTA LLENAR"
                        : apendice2Yanacocha.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                    .EVALUACION_OFTALMOLOGICA_APENDICE_N_2_YANACOCHA_PRESION_INTRAOCULAR_OI)
                            .v_MeasurementUnitName;
                ...
                cells = new List<PdfPCell>()
                {
                    new PdfPCell(new Phrase("OJOS", fontColumnValue))
                    {
                        Rowspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    new PdfPCell(new Phrase("SIN CORREGIR", fontColumnValue))
                    {
                        Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    new PdfPCell(new Phrase("CORREGIDA", fontColumnValue))
                    {
                        Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    ...
                    //Linea 
                    new PdfPCell(new Phrase("O.D", fontColumnValue))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    new PdfPCell(new Phrase("O.I", fontColumnValue))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    ...
                    new PdfPCell(new Phrase("REFLEJOS PUPILARES", fontColumnValue))
                    {
                        Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    ...
                    {
                        Rowspan = 3, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    ...
                    new PdfPCell(new Phrase("FONDO DE OJO", fontColumnValue1))
                    {
                        Rowspan = 3, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    new PdfPCell(new Phrase("Mácula", fontColumnValue1))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    new PdfPCell(new Phrase("OD: " + maculaOD, fontColumnValue1))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    new PdfPCell(new Phrase("OI: " + maculaOI, fontColumnValue1))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },

                    new PdfPCell(new Phrase("Nevio Opt", fontColumnValue1))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    new PdfPCell(new Phrase("OD: " + nervioOpticoOD, fontColumnValue1))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    new PdfPCell(new Phrase("OI: " + nervioOpticoOI, fontColumnValue1))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },

                    new PdfPCell(new Phrase("Retina", fontColumnValue1))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    new PdfPCell(new Phrase("OD: " + retinaOD, fontColumnValue1))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    new PdfPCell(new Phrase("OI: " + retinaOI, fontColumnValue1))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    ...
                    new PdfPCell(new Phrase("TONOMETRÍA (PIO)", fontColumnValue))
                    {
                        Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    new PdfPCell(new Phrase("OD: " + presionIntraOcOD + " " + npresionIntraOcODMed, fontColumnValue1))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    new PdfPCell(new Phrase("OI: " + presionIntraOcOI + " " + presionIntraOcOIMed, fontColumnValue1))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    ...
                    new PdfPCell(new Phrase(testIshihara, fontColumnValue))
                    {
                        Colspan = 3, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
                    new PdfPCell(new Phrase(" ", fontColumnValue))
                        {Colspan = 5, HorizontalAlignment = PdfPCell.ALIGN_LEFT},
            ...
            {
                vcscod = informeOftalmoSimple.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VCSCOD) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoSimple.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VCSCOD)
                        .v_Value1Name;
                vcscoi = informeOftalmoSimple.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VCSCOI) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoSimple.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VCSCOI)
                        .v_Value1Name;
                vcccod = informeOftalmoSimple.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VCCCOD) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoSimple.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VCCCOD)
                        .v_Value1Name;
                vcccoi = informeOftalmoSimple.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VCCCOI) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoSimple.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VCCCOI)
                ...
                vlscod = informeOftalmoSimple.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VLSCOD) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoSimple.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VLSCOD)
                        .v_Value1Name;
                vlscoi = informeOftalmoSimple.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VLSCOI) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoSimple.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VLSCOI)
                        .v_Value1Name;
                vlccod = informeOftalmoSimple.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VLCCOD) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoSimple.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VLCCOD)
                        .v_Value1Name;
                vlccoi = informeOftalmoSimple.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VLCCOI) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoSimple.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VLCCOI)
                ...
                testIshihara =
                    informeOftalmoSimple.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VISION_COLORES) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoSimple.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_VISION_COLORES).v_Value1Name;
                enfermedadesOculares =
                    informeOftalmoSimple.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_ENFERMEDADES_OCULARES) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoSimple.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .EXAMEN_OFTALMOLOGICO_SIMPLE_ENFERMEDADES_OCULARES).v_Value1;
                reflejosPupilares =
                    informeOftalmoSimple.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_REFLEJOS_PUPILARES) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoSimple.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_SIMPLE_REFLEJOS_PUPILARES).v_Value1Name;
            ...
            {
                vlscod = informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VLSCOD) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VLSCOD)
                        .v_Value1Name;
                vlscoi = informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VLSCOI) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VLSCOI)
                        .v_Value1Name;
                vlccod = informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VLCCOD) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VLCCOD)
                        .v_Value1Name;
                vlccoi = informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VLCCOI) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VLCCOI)
                ...
                vcscod = informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VCSCOD) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VCSCOD)
                        .v_Value1Name;
                vcscoi = informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VCSCOI) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VCSCOI)
                        .v_Value1Name;
                vcccod = informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VCCCOD) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VCCCOD)
                        .v_Value1Name;
                vcccoi = informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VCCCOI) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_VCCCOI)
                ...
                flyTest = informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                              p.v_ComponentFieldsId ==
                              Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_FLY_TEST) == null
                    ? "FALTA LLENAR"
                    : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_FLY_TEST)
                        .v_Value1;

                var meo =
                    informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_MEO) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_MEO)
                            .v_Value1;
                var sa = informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_SA) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_SA).v_Value1;
                var anexos =
                    informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_ANEXOS) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_ANEXOS)
                            .v_Value1;
                var fondoOjo =
                    informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_FONDO_OJO) ==
                    null
                        ? "FALTA LLENAR"
                        : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId ==
                                Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_FONDO_OJO)
                            .v_Value1;

                var tonometriaOD =
                    informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_TONOMETRIA_OD) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_TONOMETRIA_OD).v_Value1;
                var tonometriaODUnidad =
                    informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_TONOMETRIA_OD) == null
                        ? ""
                        : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId ==
                                Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_TONOMETRIA_OD)
                            .v_MeasurementUnitName;
                var tonometriaOI =
                    informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_TONOMETRIA_OI) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_TONOMETRIA_OI).v_Value1;
                var tonometriaOIUnidad =
                    informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_TONOMETRIA_OI) == null
                        ? ""
                        : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId ==
                                Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_TONOMETRIA_OI)
                            .v_MeasurementUnitName;

                var refraccion =
                    informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_REFRACCION) ==
                    null
                        ? "FALTA LLENAR"
                        : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId ==
                                Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_REFRACCION)
                            .v_Value1;
                reflejosPupilares =
                    informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_REFLEJOS_PUPILARES) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .EXAMEN_OFTALMOLOGICO_COMPLETO_REFLEJOS_PUPILARES).v_Value1Name;

                testIshihara =
                    informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_TEST_ISHIHARA) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_TEST_ISHIHARA).v_Value1Name;
                var testWaggoner =
                    informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_TEST_WAGGONER) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_TEST_WAGGONER).v_Value1;
                var testLegrand =
                    informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_TEST_LEGRAND) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoCompleto.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.EXAMEN_OFTALMOLOGICO_COMPLETO_TEST_LEGRAND).v_Value1;
                ...
                cells = new List<PdfPCell>()
                {
                    ...
                    new PdfPCell(new Phrase(flyTest, fontColumnValue))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
            ...
            {
                var examenCliniciExterno =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_EXAM_CLIN_EXTERNO) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_EXAM_CLIN_EXTERNO).v_Value1;
                var correctoresOcularesSi =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .INFORME_OFTALMOLOGICO_HUDBAY_CORRECTORES_OCULARES_SI) == null
                        ? ""
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .INFORME_OFTALMOLOGICO_HUDBAY_CORRECTORES_OCULARES_SI).v_Value1;
                var correctoresOcularesNo =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .INFORME_OFTALMOLOGICO_HUDBAY_CORRECTORES_OCULARES_NO) == null
                        ? ""
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .INFORME_OFTALMOLOGICO_HUDBAY_CORRECTORES_OCULARES_NO).v_Value1;

                vcscod = informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VCSCOD) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VCSCOD)
                        .v_Value1Name;
                vcscoi = informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VCSCOI) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VCSCOI)
                        .v_Value1Name;
                vcccod = informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VCCCOD) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VCCCOD)
                        .v_Value1Name;
                vcccoi = informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VCCCOI) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VCCCOI)
                ...
                vlscod = informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VLSCOD) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VLSCOD)
                        .v_Value1Name;
                vlscoi = informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VLSCOI) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VLSCOI)
                        .v_Value1Name;
                vlccod = informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VLCCOD) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VLCCOD)
                        .v_Value1Name;
                vlccoi = informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                             p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VLCCOI) ==
                         null
                    ? "FALTA LLENAR"
                    : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VLCCOI)
                ...
                var movOcOD =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .INFORME_OFTALMOLOGICO_HUDBAY_MOVIMIENTOS_OCULARES_OD) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .INFORME_OFTALMOLOGICO_HUDBAY_MOVIMIENTOS_OCULARES_OD).v_Value1;
                var movOcOI =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants
                            .INFORME_OFTALMOLOGICO_HUDBAY_MOVIMIENTOS_OCULARES_OI) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .INFORME_OFTALMOLOGICO_HUDBAY_MOVIMIENTOS_OCULARES_OI).v_Value1;

                var fonOjoOD =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_FONDO_OJO_OD) ==
                    null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_FONDO_OJO_OD).v_Value1;
                var fonOjoOI =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_FONDO_OJO_OI) ==
                    null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_FONDO_OJO_OI).v_Value1;

                var poloAntOD =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_POLO_ANTERIOR_OD) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_POLO_ANTERIOR_OD).v_Value1;
                var poloAntOI =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_POLO_ANTERIOR_OI) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_POLO_ANTERIOR_OI).v_Value1;

                var camaraAntOD =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_CAMARA_ANTERIOR_OD) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_CAMARA_ANTERIOR_OD).v_Value1;
                var camaraAntOI =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_CAMARA_ANTERIOR_OI) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_CAMARA_ANTERIOR_OI).v_Value1;

                var cristalinoOD =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_CRISTALINO_OD) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_CRISTALINO_OD).v_Value1;
                var cristalinoOI =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_CRISTALINO_OI) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_CRISTALINO_OI).v_Value1;

                var vitreoOD =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VITREO_OD) ==
                    null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId ==
                                Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VITREO_OD)
                            .v_Value1;
                var vitreoOI =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VITREO_OI) ==
                    null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId ==
                                Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VITREO_OI)
                            .v_Value1;

                var nervioOptOD =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_NERVIO_OPTICO_OD) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_NERVIO_OPTICO_OD).v_Value1Name;
                var nervioOptOI =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_NERVIO_OPTICO_OI) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_NERVIO_OPTICO_OI).v_Value1Name;

                var vasosRetinalesOD =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VASOS_RETINALES_OI) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VASOS_RETINALES_OI).v_Value1;
                ...
                retinaOD =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_RETINA_OD) ==
                    null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId ==
                                Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_RETINA_OD)
                            .v_Value1Name;
                retinaOI =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_RETINA_OI) ==
                    null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId ==
                                Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_RETINA_OI)
                            .v_Value1Name;

                var tonometriaOD =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_TONOMETRIA_OD) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_TONOMETRIA_OD).v_Value1;
                var tonometriaOI =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_TONOMETRIA_OI) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_TONOMETRIA_OI).v_Value1;

                testIshihara =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_TEST_ISHIHARA) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId ==
                            Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_TEST_ISHIHARA).v_Value1Name;
                var visionEstereoscopica =
                    informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.INFORME_OFTALMOLOGICO_HUDBAY_VISION_ESTEREOSCOPICA) == null
                        ? "FALTA LLENAR"
                        : informeOftalmoHudbay.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .INFORME_OFTALMOLOGICO_HUDBAY_VISION_ESTEREOSCOPICA).v_Value1;
            ...
            else if (findOftalmologia != null)
            {
                ...
                if (findOftalmologia != null)
                {
                    ...
                    var OD_VC_SC = findOftalmologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.OFTALMOLOGIA_SC_CERCA_OJO_DERECHO_ID);
                    if (OD_VC_SC != null)
                    {
                        if (OD_VC_SC.v_Value1Name != null) ValorOD_VC_SC = OD_VC_SC.v_Value1Name;
                    }

                    var OI_VC_SC = findOftalmologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.OFTALMOLOGIA_AGUDEZA_VISUAL_CERCA_SC_OJO_IZQUIERDO);
                    if (OI_VC_SC != null)
                    {
                        if (OI_VC_SC.v_Value1Name != null) ValorOI_VC_SC = OI_VC_SC.v_Value1Name;
                    }

                    var OD_VC_CC = findOftalmologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.OFTALMOLOGIA_AGUDEZA_VISUAL_CERCA_CC_OJO_DERECHO);
                    if (OD_VC_CC != null)
                    {
                        if (OD_VC_CC.v_Value1Name != null) ValorOD_VC_CC = OD_VC_CC.v_Value1Name;
                    }

                    var OI_VC_CC = findOftalmologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.OFTALMOLOGIA_CC_CERCA_OJO_IZQUIERDO_ID);
                    if (OI_VC_CC != null)
                    {
                        if (OI_VC_CC.v_Value1Name != null) ValorOI_VC_CC = OI_VC_CC.v_Value1Name;
                    }

                    var OD_VL_SC = findOftalmologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.OFTALMOLOGIA_SC_LEJOS_OJO_DERECHO_ID);
                    if (OD_VL_SC != null)
                    {
                        if (OD_VL_SC.v_Value1Name != null) ValorOD_VL_SC = OD_VL_SC.v_Value1Name;
                    }

                    var OI_VL_SC = findOftalmologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.OFTALMOLOGIA_SC_LEJOS_OJO_IZQUIERDO_ID);
                    if (OI_VL_SC != null)
                    {
                        if (OI_VL_SC.v_Value1Name != null) ValorOI_VL_SC = OI_VL_SC.v_Value1Name;
                    }

                    var OD_VL_CC = findOftalmologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.OFTALMOLOGIA_CC_LEJOS_OJO_DERECHO_ID);
                    if (OD_VL_CC != null)
                    {
                        if (OD_VL_CC.v_Value1Name != null) ValorOD_VL_CC = OD_VL_CC.v_Value1Name;
                    }

                    var OI_VL_CC = findOftalmologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.OFTALMOLOGIA_CC_LEJOS_OJO_IZQUIERDO_ID);
                    if (OI_VL_CC != null)
                    {
                    ...
                    if (TestIshiharaa != null)
                    {
                        string TestIshiharaNormal =
                            TestIshiharaa.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId == Sigesoft.Common.Constants.TEST_ISHIHARA_NORMAL) == null
                                ? ""
                                : TestIshiharaa.ServiceComponentFields.Find(p =>
                                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.TEST_ISHIHARA_NORMAL)
                                    .v_Value1; // TestIshihara.Count() == 0 || (TestIshihara.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.TEST_ISHIHARA_NORMAL)) == null ? string.Empty : (TestIshihara.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.TEST_ISHIHARA_NORMAL)).v_Value1;
                        string TestIshiharaAnormal =
                            TestIshiharaa.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId == Sigesoft.Common.Constants.TEST_ISHIHARA_ANORMAL) == null
                                ? ""
                                : TestIshiharaa.ServiceComponentFields.Find(p =>
                                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.TEST_ISHIHARA_ANORMAL)
                                    .v_Value1; // TestIshihara.Count() == 0 || (TestIshihara.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.TEST_ISHIHARA_ANORMAL)) == null ? string.Empty : (TestIshihara.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.TEST_ISHIHARA_ANORMAL)).v_Value1;
                        string Dicromatopsia =
                            TestIshiharaa.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId == Sigesoft.Common.Constants.CAMPIMETRIA_OD) == null
                                ? ""
                                : TestIshiharaa.ServiceComponentFields.Find(p =>
                                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.CAMPIMETRIA_OD)
                                    .v_Value1Name; // TestIshihara.Count() == 0 || (TestIshihara.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.TEST_ISHIHARA_DESC)) == null ? string.Empty : (TestIshihara.Find(p => p.v_ComponentFieldId == Sigesoft.Common.Constants.TEST_ISHIHARA_DESC)).v_Value1Name;
                ...
                cells = new List<PdfPCell>()
                {
                    ...
                    new PdfPCell(new Phrase("CORREGIDA", fontColumnValue))
                        {Colspan = 2, HorizontalAlignment = PdfPCell.ALIGN_CENTER},
                    new PdfPCell(new Phrase("ENFERMEDADES OCULARES", fontColumnValue)),
                    new PdfPCell(new Phrase(ValorEnfermedadesOculares, fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                    //Linea 
                    ...
                    new PdfPCell(new Phrase("REFLEJOS PUPILARES", fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                    new PdfPCell(new Phrase(ValorReflejosPupilares, fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                    //Linea
                    new PdfPCell(new Phrase("VISIÓN DE CERCA", fontColumnValueBold))
                        {HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                    new PdfPCell(new Phrase(ValorOD_VC_SC, fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_CENTER},
                    new PdfPCell(new Phrase(ValorOI_VC_SC, fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_CENTER},
                    new PdfPCell(new Phrase(ValorOD_VC_CC, fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_CENTER},
                    new PdfPCell(new Phrase(ValorOI_VC_CC, fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_CENTER},
                    new PdfPCell(new Phrase("FONDO DE OJO", fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                    new PdfPCell(new Phrase(ValorFondoDeOjo, fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                    //Linea
                    new PdfPCell(new Phrase("VISIÓN DE LEJOS", fontColumnValueBold))
                        {HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                    new PdfPCell(new Phrase(ValorOD_VL_SC, fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_CENTER},
                    new PdfPCell(new Phrase(ValorOI_VL_SC, fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_CENTER},
                    new PdfPCell(new Phrase(ValorOD_VL_CC, fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_CENTER},
                    new PdfPCell(new Phrase(ValorOI_VL_CC, fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_CENTER},
                    new PdfPCell(new Phrase("TONOMETRÍA (PIO)", fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                    new PdfPCell(new Phrase(ValorTonometria, fontColumnValue))
                        {HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                    //Linea
                    new PdfPCell(new Phrase("VISIÓN DE COLORES", fontColumnValueBold))
                        {HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                    new PdfPCell(new Phrase(ValorDiscromatopsia, fontColumnValue))
                        {Colspan = 3, HorizontalAlignment = PdfPCell.ALIGN_LEFT},
                    new PdfPCell(new Phrase(" ", fontColumnValue))
                        {Colspan = 3, HorizontalAlignment = PdfPCell.ALIGN_LEFT},
            ...
            else
            {
                cells = new List<PdfPCell>()
                {
                    ...
                    new PdfPCell(new Phrase("N/A", fontColumnValue))
                    {
                        HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE
                    },
            ...
            //string PsicologiaConclusiones =
            //    Psicologia.Count() == 0 || (Psicologia.Find(p =>
            //        p.v_ComponentFieldId == Sigesoft.Common.Constants.PSICOLOGIA_APTITUD_PSICOLOGICA_ID)) == null
            //        ? string.Empty
            //        : (Psicologia.Find(p =>
            //            p.v_ComponentFieldId == Sigesoft.Common.Constants.PSICOLOGIA_APTITUD_PSICOLOGICA_ID)).v_Value1;

            var PsicologiaConclusiones = ListDiagnosticRepository.FindAll(p =>
                p.v_ComponentId == Sigesoft.Common.Constants.PSICOLOGIA_ID ||
                p.v_ComponentId == Sigesoft.Common.Constants.HISTORIA_CLINICA_PSICOLOGICA_ID || 
                p.v_ComponentId == Sigesoft.Common.Constants.INFORME_PSICOLOGICO_RESUMEN_ID);

            var ListaConcatenadaPsicologia = string.Join(", ", PsicologiaConclusiones.Select(p => p.v_DiseasesName));


            //List<ServiceComponentList> ListaExamenesPsicologicos =
            //    ExamenesServicio.FindAll(p => p.i_CategoryId == 7).ToList();
            ...
            //DiagnosticosPsicologicos = DiagnosticosPsicologicos == ""
            //    ? string.Empty
            //    : DiagnosticosPsicologicos.Substring(0, DiagnosticosPsicologicos.Length - 1);
            //cells = new List<PdfPCell>();
            ...
            if (Psicologia.Count() != 0)
            {
                ...
                {
                    //fila
                    new PdfPCell(new Phrase(ListaConcatenadaPsicologia, fontColumnValue)),
                    //fila
            ...
            filiationWorker = HandlingItextSharp.GenerateTableFromCells(cells, columnWidths,
                "VII. CONCLUSIONES DE EVALUACIÓN PSICOLÓGICA", fontTitleTable);
            ...
            var Lista = ListDiagnosticRepository.FindAll(p =>
                p.v_ComponentId == Sigesoft.Common.Constants.RX_TORAX_ID ||
                p.v_ComponentId == Sigesoft.Common.Constants.OIT_ID || p.v_ComponentId == Sigesoft.Common.Constants.RADIOGRAFIA_DE_TORAX_SIMPLE_ID);
            ...
            columnWidths = new float[] {100f};
            filiationWorker = HandlingItextSharp.GenerateTableFromCells(cells, columnWidths,
                "VIII. CONCLUSIONES RADIOGRÁFICAS", fontTitleTable);
            ...
            ValoresLaboratorio = ValoresLaboratorio == ""
                ? string.Empty
                : ValoresLaboratorio.Substring(0, ValoresLaboratorio.Length - 1);
            cells = new List<PdfPCell>();
            ...
            filiationWorker = HandlingItextSharp.GenerateTableFromCells(cells, columnWidths,
                "IX. HALLAZGOS DE LABORATORIO", fontTitleTable);
            ...
            var existeAudio = ExamenesServicio.Find(p =>
                p.v_ComponentId == Sigesoft.Common.Constants.AUDIOMETRIA_ID || p.v_ComponentId == "N005-ME000000005");
            cells = new List<PdfPCell>();
            ...
            if (existeAudio != null) // El examen esta contemplado en el protocolo del paciente
            {
                ...
                var ListaAudioMetriaDx = ListDiagnosticRepository.FindAll(p =>
                    p.v_ComponentId == Sigesoft.Common.Constants.AUDIOMETRIA_ID ||
                    p.v_ComponentId == "N005-ME000000005");
            ...
            filiationWorker = HandlingItextSharp.GenerateTableFromCells(cells, columnWidths,
                "X. CONCLUSIONES AUDIOMETRÍA", fontTitleTable);
            ...
            if (existeEspiro != null) // El examen esta contemplado en el protocolo del paciente
            {
                ...
                var ListaEspirometriaDx =
                    ListDiagnosticRepository.FindAll(p => p.v_ComponentId == Sigesoft.Common.Constants.ESPIROMETRIA_ID);
            ...
            filiationWorker = HandlingItextSharp.GenerateTableFromCells(cells, columnWidths,
                "XI. CONCLUSIONES DE ESPIROMETRÍA", fontTitleTable);
            ...
            {
                Sigesoft.Common.Constants.PSICOLOGIA_ID,
            ...
            int[] excludeCategoryTypeExam =
            {
                (int) Sigesoft.Common.CategoryTypeExam.Laboratorio,
            ...
            {
                table = TableBuilderReportFor312(oe, fontTitleTable, fontSubTitleNegroNegrita, fontColumnValue,
            ...
            var DxOcupacionales = ListDiagnosticRepository.FindAll(p =>
                p.i_DiagnosticTypeId == (int) Sigesoft.Common.TipoDx.Enfermedad_Ocupacional ||
                p.i_DiagnosticTypeId == (int) Sigesoft.Common.TipoDx.Accidente_Ocupacional);
            ...
            filiationWorker = HandlingItextSharp.GenerateTableFromCells(cells, columnWidths,
                "XIII. DIAGNÓSTICOS MÉDICO OCUPACIONALES", fontTitleTable);
            ...
            table = HandlingItextSharp.GenerateTableFromCells(cellsTit2, columnWidths, PdfPCell.NO_BORDER, null,
                fontTitleTable);
