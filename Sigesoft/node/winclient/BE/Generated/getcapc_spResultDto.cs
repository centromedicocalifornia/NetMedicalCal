...
{
    [DataContract()]
    public partial class getcapc_spResultDto
    {
        [DataMember()]
        ...
        public getcapc_spResultDto()
        {
        }

        public getcapc_spResultDto(Nullable<Int32> i_CategoryId, String categoria, String resultado, String v_FirstName, String v_FirstLastName, String v_SecondLastName, Byte[] b_Logo, String v_DocNumber, String v_DocTypeName, Nullable<DateTime> d_BirthDate, String v_GenderName, Nullable<Int32> i_EsoTypeId_Old, String v_OccupationName, String v_OrganizationPartialName, String v_ProtocolName, Nullable<Int32> i_AptitudeStatusId, Nullable<DateTime> d_ServiceDate, String v_DiseasesName, String v_DiagnosticRepositoryId, String grupo, String factor, Byte[] g_Image, String v_EsoTypeName, String v_ServiceId, Nullable<Int32> i_DiagnosticTypeId, String v_ComponentId, String v_ObsStatusService, Byte[] b_Photo)
        {
